...
public class FulltextSearch
{
	...
	public static void indexLemmas(String language)
	{
		...
		try
		{
			cdb.start(LuceneUtils.LUCENE_INDEX + File.separatorChar + "lemmas" + File.separatorChar + language + ".cdb");
	...
	public static void indexSynonyms(String language)
	{
		...
		try
		{
			cdb.start(LuceneUtils.LUCENE_INDEX + File.separatorChar + "synonyms" + File.separatorChar + language + ".cdb");
