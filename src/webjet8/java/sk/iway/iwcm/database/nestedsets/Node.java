...
{
	/**
	 * Moves this node in the tree, positioning it as the last child of the
	 * given node.
	 *
	 * @param dest
	 */
	...
	/**
	 * Moves this node in the tree, positioning it as the first child of the
	 * given node.
	 *
	 * @param dest
	 */
	...
	/**
	 * Tests if the node has a parent. If it does not have a parent, it is a
	 * root node.
	 *
	...
	/**
	 * Tests whether the node is a valid node. A valid node is a node with a
	 * valid position in the tree, represented by its left, right and level
	 * values.
	 *
