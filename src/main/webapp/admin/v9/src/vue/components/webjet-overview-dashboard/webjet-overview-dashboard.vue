    ...
    <div class="row">
      <div class="col-lg-9">
        ...
        <webjet-overview-dashboard-websites
          v-bind:overviewrecentpages="overviewrecentpages"
...
export default {
    ...
    mounted() {
        //console.log("Mounted 1, props=", this.$props, " errors=", this.$props.overviewbackdata.statErrorNumber);
    }
}
</script>

<style lang="scss">
#webjet-overview-dashboard {
