        ...
        this.EDITOR.TABLE.DATA.fields.forEach(column => {
            if("object" == typeof column.ai && column.ai != null && column.ai.length > 0) {
                ...
                if (field) {
                    ...
                    } else if ("options"===column.type || "enumeration"===column.type || "optionsBasic"===column.type) {
                        //skip OPTIONS, ENUMERATION, OPTIONS_BASIC field type - AI button is not supported
                    } else {
