...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.sk = {
		...
		messages   : {
			...
			'cmddirprops'  : 'Nastavenie adresáru',
			'cmdfileprops' : 'Nastavenie súboru',
			'cmdwjmetadata' : 'Bezpečnostné nastavenia def',
            'cmdfileupdate'  : 'Aktualizovať súbor',
			...
			'sortsort_priority' : 'podľa poradia', // from 04.08.2020
