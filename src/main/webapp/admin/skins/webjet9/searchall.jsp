...
<%@ page pageEncoding="windows-1250"  import="sk.iway.iwcm.Constants,sk.iway.iwcm.Identity,sk.iway.iwcm.PathFilter,sk.iway.iwcm.Tools" %>
...
<logic:present name="searchResults">
	...
	<!--
		...
		function showDoc(event, ui){
			window.open("/admin/v9/webpages/web-pages-list/?docid="+ui.item.doc_id);
		}
	//-->
	</script>
	...
	<%SearchResult sr = (SearchResult)result;%>
		...
		<display:column titleKey="groupslist.approve.tools" style="width:220px;">
			...
			if("sk.iway.iwcm.search.DocDetailsSearch".equals(sr.getType()))
			{%>
				<a href="/admin/v9/webpages/web-pages-list/?docid=<%=sr.getDocId() %>" title='<iwcm:text key="groupslist.edit_web_page"/>'><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
