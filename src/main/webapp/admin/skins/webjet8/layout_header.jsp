				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown user">
						<a id="userDropdownMenu" href="#" class="dropdown-toggle" data-bs-toggle="dropdown" data-close-others="true">
							...
							<span class="username">
								<iwcm:beanWrite name="iwcm_useriwcm" property="fullName"/>
							</span>
							<i class="ti ti-chevron-down"></i>
						</a>
						<ul class="dropdown-menu" aria-labelledby="userDropdownMenu">
							<li style="display: none;">
								<a href="javascript:openPopupDialogFromLeftMenu('/admin/edituser.do?userid=<iwcm:beanWrite name="iwcm_useriwcm" property="userId"/>');">
									<i class="ti ti-user"></i> <iwcm:text key="components.forum.bb.profile"/>
								</a>
							</li>
							<li>
								<a href="javascript:openPopupDialogFromLeftMenu('/admin/2factorauth.jsp?userid=<iwcm:beanWrite name="iwcm_useriwcm" property="userId"/>');">
