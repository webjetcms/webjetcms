...
{   
   ...
   for (index = 0; index < vstup.value.length; index++) 
   {
      ...
      if (ch != "0" && ch != "1" && ch != "2" && ch != "3" && ch != "4" && ch != "5" && ch != "6" && ch != "7" && ch != "8" && ch != "9" && ch != ".") 
         {text="Dátum musí by vo formáte DD.MM.RRRR (DD=deò, MM=mesiac, RRRR=rok).\r"}
   ...
   if ((den<1 || den >31) && (text == ""))
      {text=text + "Poèet dní v mesiaci nesmie by menej ako 1 alebo viac ako 31.\r"}
   if ((mesic<1 || mesic>12) && (text == ""))
      {text=text + "Mesiac nemôe by menší ako 1 alebo väèší ako 12.\r"}
   if (rok<1998 && tecka == 2 && text == "" && rok != "")
      {text=text + "Rok nemôe by menší ako 1998.\r"}
   if ((tecka == 2 && rok == "") || (tecka > 2) || rok=="")
      {text=text+ "Dátum musí by vo formáte DD.MM.RRRR (DD=deò, MM=mesiac, RRRR=rok).\r"}
   if (mesic == 2)
   {
      if (rok != "")
         {
   ...
   if ((mesic == 4 || mesic == 6 || mesic == 9 || mesic == 11) && (den>30))
      {text=text + "Poèet dní vo vybranom mesiaci nesmie by menej ako 1 alebo viac ako 30.\r"}
...
{      
   ...
   {        
      window.alert("Zadanı èas nie je korektnı");
      Field.select();
      Field.focus();
      return Field;
   }
...
function checkEndTime(fieldStart, fieldEnd, b_isEnd)
{
   ...
   else
   {
      ...
      {
         fieldEnd.value = "";
         window.alert("Koncovı cas nemôe byt skor ako zaciatocnı.");
         return;
      }
   }
...
{   
  if (vstup && vstup.value && vstup.value.length > 0)
  {
   ...
   for (index = 0; index < vstup.value.length; index++)
   {
      ch = vstup.value.charAt(index);
      if (ch != "0" && ch != "1" && ch != "2" && ch != "3" && ch != "4" && ch != "5" && ch != "6" && ch != "7" && ch != "8" && ch != "9" && ch != ".")
         {text="Dátum musí by vo formáte DD.MM alebo DD.MM.RRRR (DD=deò, MM=mesiac, RRRR=rok).\r"}
      if ((ch == "0" || ch == "1" || ch == "2" || ch == "3" || ch == "4" || ch == "5" || ch == "6" || ch == "7" || ch == "8" || ch == "9") && (text ==""))
      {
         if (tecka == 0)
            {den=den + ch}
   ...
   if (rok<1900 && tecka == 2 && text == "" && rok != "")
      {text=text + "Rok nemôe by menší ako 1900.\r"}
   if ((tecka == 2 && rok == "") || (tecka > 2))
      {text=text+ "Dátum musí by vo formáte DD.MM alebo DD.MM.RRRR (DD=deò, MM=mesiac, RRRR=rok).\r"}
   if (mesic == 2)
   {
      if (rok != "")
         {
...
function checkEndTime(fieldStart, fieldEnd, b_isEnd)
{
   ...
   else
   {
      ...
      {
         fieldEnd.value = "";
         window.alert("Koncovı cas nemôe byt skôr ako zaèiatoènı.");
         return;
      }
   }
   lastTimeDif = minutesEnd - minutesStart;
