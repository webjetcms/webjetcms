...
<form action="cleanup.jsp" method="post">
	...
	<iwcm:iterate name="modules" id="m" type="sk.iway.iwcm.system.ModuleInfo">
		<input type="checkbox" name="m_<iwcm:strutsWrite name="m" property="itemKey"/>" value="delete"> <iwcm:text key="<%=m.getNameKey()%>"/> [<iwcm:strutsWrite name="m" property="itemKey"/>]<br>
	</iwcm:iterate>
