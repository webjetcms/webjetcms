...
<% for(int i = 0; i < itemsList.length(); i++) { %>
	<% JSONObject item = itemsList.getJSONObject(i); %>	
				...
				%><div class="col-sm-12  testimonials_content <%=easyingStyle %>" data-delay="<%=delay %>" data-speed="<%=dataSpeed %>" style="<%=customStyle%>">
				<span class="inner">
				
				<div class="testimonials-text" style="width:100%">
