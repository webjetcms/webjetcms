<%sk.iway.iwcm.Encoding.setResponseEnc(request, response, "text/javascript"); sk.iway.iwcm.PathFilter.setStaticContentHeaders("/cache/popcalendar.js", null, request, response);%><%@ page pageEncoding="utf-8" import="sk.iway.iwcm.*" %>
...
document.write("}");
document.write("#calendar a { cursor: pointer; padding: 0px; margin: 0px; }");
document.write("</style>");
...
//	email  : pinotoy@yahoo.com
	...
	var img      = new Array();
	var bShow    = false;
	var popCalendarDisableHide = true;
	var calendarRows = 5;
	...
	*/
	...
	if (dom) {
		...
		document.write ('<iframe id="calendarFrame" src="/components/iframe_blank.jsp" style="z-index:+900;position:absolute;visibility:hidden;width:220px;height:150px;border:0px; top: -200px;" frameborder="0"></iframe><div onclick="bShow=true" id="calendar" style="z-index:+999;position:absolute;visibility:hidden;width:220px;">');
	...
	{
		window.addEventListener("load", initCalendar, true);
	}
	else 
	{
