...
<%pageContext.setAttribute("stripesCanonicalName", stripesClass.getCanonicalName()); %>
<%-- <stripes:useActionBean var="actionBean" beanclass="<%=stripesClass.getCanonicalName()%>" /> --%>
<stripes:useActionBean var="actionBean" beanclass="${stripesCanonicalName}" />
