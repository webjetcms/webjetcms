    ...
    $.fn.ashtml5lightbox = function (options) {
        ...
        inst.createMarkup = function () {
            ...
            if (inst.options.titlestyle == "right" || inst.options.titlestyle == "left") {
                ...
                if (inst.options.titlestyle == "right") {
                    ...
                    inst.$elemData.css({
                        position: "relative",
                        overflow: "hidden", padding: inst.options.bordersize + "px"
                    })
                } else {
        ...
        inst.showVideo = function (elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function () {
                ...
                var isHTML5 = false;
                if (inst.options.isIE678 || elem[ELEM_TYPE] == 8 || inst.options.isIE9 && inst.options.useflashonie9 || inst.options.isIE10 && inst.options.useflashonie10 || inst.options.isIE11 && inst.options.useflashonie11) isHTML5 = false; else if (inst.options.isMobile) isHTML5 = true; else if ((inst.options.html5player || !inst.options.flashInstalled) && inst.options.html5VideoSupported) if (!inst.options.isFirefox && !inst.options.isOpera || (inst.options.isFirefox || inst.options.isOpera) &&
        ...
        inst.resizeWindow = function () {
            ...
            if (inst.options.responsivebarheight) {
                if (winH <=
                    inst.options.smallscreenheight) inst.options.barheight = inst.options.barheightonsmallheight; else inst.options.barheight = inst.options.barheightoriginal;
            ...
            if (inst.currentElem[ELEM_TYPE] == 0) keepratio = inst.options.imagekeepratio; else if (inst.currentElem[ELEM_TYPE] == 7 || inst.currentElem[ELEM_TYPE] == 10) {
                ...
                createNav: function () {
                    ...
                    if (this.options.navstyle == "thumbnails") {
                        ...
                        if (this.options.navthumbstyle ==
                            "imageandtitle") this.options.navheight += this.options.navthumbtitleheight; else if (this.options.navthumbstyle == "imageandtitledescription" || this.options.navthumbstyle == "textonly") this.options.navwidth += this.options.navthumbtitlewidth
                    }
                    if (this.options.navdirection == "vertical") {
                        var len = this.options.navstyle == "none" ? 0 : this.elemArray.length * this.options.navheight + (this.elemArray.length - 1) * this.options.navspacing;
                        if (this.options.navshowbuttons) {
                    ...
                    $nav.css({
                        display: "block", position: this.options.navdirection == "horizontal" &&
                        this.options.navmultirows ? "relative" : "absolute", height: "auto"
                    });
                    ...
                    this.options.navimagewidth = this.options.navwidth - this.options.navborder * 2;
                    this.options.navimageheight = this.options.navheight - this.options.navborder * 2;
                    if (this.options.navthumbstyle == "imageandtitle") this.options.navheight += this.options.navthumbtitleheight; else if (this.options.navthumbstyle == "imageandtitledescription" ||
                    ...
                    if (this.isAnimating) {
                        ...
                        if (Math.abs(this.curImageMarginLeft) > 0) imageCodes += "max-width:" + this.curImageMaxWidth + "%;width:" + this.curImageMaxWidth + "%;height:100%;left:0%;top:0%;margin-left:" + this.curImageMarginLeft + "%"; else imageCodes += "max-width:" + this.curImageMaxWidth + "%;width:" +
                ...
                showImage: function (slideDirection, transEffect) {
                    ...
                    $(imgLoader).on("load", function () {
                        ...
                        if (Math.abs(instance.curImageMarginLeft) > 0) imgCurCodes += "max-width:" +
                            instance.curImageMaxWidth + "%;width:" + instance.curImageMaxWidth + "%;height:100%;left:0%;top:0%;margin-left:" + instance.curImageMarginLeft + "%"; else imgCurCodes += "max-width:" + instance.curImageMaxWidth + "%;width:" + instance.curImageMaxWidth + "%;height:auto;left:0%;top:0%;margin-top:" + instance.curImageMarginTop + "%;";
...
(function ($) {
    ...
    $.fn.threedTransition = function (id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        $cubeWrapper.css(ASPlatforms.applyBrowserStyles({
            "transform-style": "preserve-3d", "perspective": options.perspective,
