...
%>
<iwcm:script type="text/javascript"> // CLASSIC skin
...
jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-<%=multipleSliderId%>").amazingslider({
        ...
        transitiononfirstslide:<%=pageParams.getBooleanValue("transition_on_first_slide",false)%>,
        ...
        skin: "<%=pageParams.getValue("skin","TextNavigation")%>",
        ...
        navthumbnavigationarrowimage:"<%=support_images_path%>"+"carouselarrows-32-32-2.png",
        ...
        navshowpreview: <%= pageParams.getBooleanValue("show_thumbnails",false)%>,

        navpreviewarrowheight:8,

        navmarginx:16,

        navfeaturedarrowimage:"<%=support_images_path%>"+"featuredarrow-16-8-2.png",

        navthumbsmallsize:480,

        showribbon:false,

        navstyle: "<%=pageParams.getValue("nav_style","thumbnails")%>",

        textpositionmarginleft:24,

        descriptioncss:"display:block; position:relative; font:12px \"Lucida Sans Unicode\",\"Lucida Grande\",sans-serif,Arial; color:#fff; margin-top:8px;",

        navplaypauseimage:"<%=support_images_path%>"+"navplaypause-48-48-0.png",

        backgroundimagetop:-10,

        timercolor: "<%=pageParams.getValue("autoplay_countdown_color","#ee330a")%>" ,
        ...
        navimage:"<%=support_images_path%>"+"bullet-24-24-5.png",
        ...
        bottomshadowimage:"<%=support_images_path%>"+"bottomshadow-110-95-4.png",
        ...
        showbottomshadow: <%=pageParams.getBooleanValue("show_shadow_bottom",false)%>,
