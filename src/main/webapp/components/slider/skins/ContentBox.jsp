...
%>
<iwcm:script type="text/javascript"> // CONTENTBOX skin
...
jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-<%=multipleSliderId%>").amazingslider({
        ...
        skin: "<%=pageParams.getValue("skin","ContentBox")%>",
        ...
        navimage:"<%=support_images_path%>"+"bullet-16-16-0.png",
        ...
        bottomshadowimage:"<%=support_images_path%>"+"bottomshadow-110-95-1.png",
