...
jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-<%=multipleSliderId%>").amazingslider({
        ...
        skin: "<%=pageParams.getValue("skin","Frontpage")%>",
        ...
        arrowimage:"<%=support_images_path%>"+"arrows-48-48-3.png",
        ...
        navimage:"<%=support_images_path%>"+"bullet-12-12-0.png",
        ...
        bottomshadowimage:"<%=support_images_path%>"+"bottomshadow-110-100-5.png",
