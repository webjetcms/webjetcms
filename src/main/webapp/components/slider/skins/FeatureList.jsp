...
%>
<iwcm:script type="text/javascript"> // FEATURE LIST skin
...
jQuery(document).ready(function(){
...

    {
        ...
        if( scripts[i].src && scripts[i].src.match(/initslider-<%=multipleSliderId%>\.js/i))
    ...
    jQuery("#amazingslider-<%=multipleSliderId%>").amazingslider({
        ...
        skin: "<%=pageParams.getValue("skin","Featurelist")%>",
        ...
        navthumbnavigationarrowimage:"<%=support_images_path%>"+"carouselarrows-32-32-1.png",
        ...
        navfeaturedarrowimage:"<%=support_images_path%>"+"featuredarrow-8-16-0.png",
