...
<script type="text/javascript">
	function setWeek2() {
		window.open("<%=PathFilter.getOrigPath(request) %>?week="+document.getElementById('datepicker2_input').value,"_self");
	}
</script>
...
<input type="week" name="week" id="datepicker2_input" class="datepicker" value="<%=week%>"/>
<input type="button" class="button50" value="<iwcm:text key="components.restaurant_menu.select"/>" onclick="setWeek2()"> 
                    ...
                    <table class="sort_table tabulkaStandard table">
                        <tr>
                            <td colspan="5" class="headline">
                                <h2 class="menu"> <iwcm:text key="dayfull.${innerList[0].dayNumber}"/> (${innerList[0].dayFormated})</h2>
                            </td>
                        </tr>
                        <tr>
