...
<%@page import="sk.iway.iwcm.components.video.VideoApp"%>
<%
...
if (file.indexOf("youtube.com") != -1 || file.indexOf("youtu.be") != -1)
{
	...
	iframeVersion += "<iframe class=\"embed-responsive-item\" id=\"videoPlaceholder"+ videoCounter +"\" width=\""+ width +"\" height=\""+ height +"\" src=\""+ Tools.escapeHtml(youtubeUrl) +"\" frameborder=\"0\" "+allowFullscreen+" referrerpolicy=\"strict-origin-when-cross-origin\"></iframe>";
