...
if (file.indexOf("youtube.com") != -1 || file.indexOf("youtu.be") != -1)
{
	...
	iframeVersion += "<iframe class=\"embed-responsive-item\" id=\"videoPlaceholder"+ videoCounter +"\" width=\""+ width +"\" height=\""+ height +"\" src=\"//www.youtube.com/embed/"+ file +"?enablejsapi=1&showinfo="+showinfo+"&autoplay="+autoplay+"&modestbranding="+branding+"&controls="+controls+"&rel="+rel+"&origin=" + Tools.getBaseHref(request) + "\" frameborder=\"0\" "+allowFullscreen+" referrerpolicy=\"strict-origin-when-cross-origin\"></iframe>";
