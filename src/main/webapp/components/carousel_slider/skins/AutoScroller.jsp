...
%>
<iwcm:script type="text/javascript"> // AUTOSCROLLER skin
...
jQuery(document).ready(function(){
    ...
    jQuery("#amazingcarousel-<%=multipleCarouselSliderIdId%>").amazingcarousel({
        jsfolder:jsFolder,
        width:<%=pageParams.getIntValue("carouselWidth",120)%>,
        height:<%=pageParams.getIntValue("carouselHeight",120)%>,
        skinsfoldername:"",
        ...
        height:<%=pageParams.getIntValue("carouselWidth",120)%>,
        ...
        visibleitems:<%=pageParams.getIntValue("imgPerSlide",5)%>,
        imagewidth:120,
