...
<%@ page pageEncoding="utf-8"
	import="sk.iway.iwcm.*,org.apache.struts.util.ResponseUtils"%>
...
<%
	...
	java.util.Map<String, String> attributes = new FormAttributeDB().load(DocTools.removeChars(name, true));
%>
