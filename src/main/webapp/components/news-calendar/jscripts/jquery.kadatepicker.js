 ...
 **/
    renderCalendar  :   function(s)
    {
      ...
      $('.dp-calendar').attr('id',month+"_"+year);
      
      if (s.wjDatum != undefined)
      {
            today = Date.fromString(s.wjDatum).zeroTime();        
          }
      ...
      while (w++<weeksToDraw) {
        ...
        for (var i=0; i<7; i++) {
          ...
          var d = $(dc('td'))
                ...
                .attr('id',currentDate.getDate()+"_"+(currentDate.getMonth()+1)+"_"+year)
              ;
          if (s.renderCallback) {
    ...
    {      
      ...
      return this.each(
        function()
        {
          ...
          if (s.wjDatum != undefined)
          {
            var today = Date.fromString(s.wjDatum).zeroTime();            
