          ...
          <iwcm:iterate id="good" name="basketItems" type="sk.iway.iwcm.components.basket.jpa.BasketInvoiceItemEntity">
            ...
            <tr class="itemTr itemId_<iwcm:strutsWrite name="good" property="itemId"/> basketId_<iwcm:strutsWrite name="good" property="basketItemId"/>">
              ...
              <td class="fL w-2">
                ...
                <input type="text" class="basketQty" name="basketQty" maxlength="4" value="<iwcm:strutsWrite name="good" property="itemQty"/>">
									...
									<tr class="itemTr itemId_<iwcm:strutsWrite name="good" property="itemId"/> basketId_<iwcm:strutsWrite name="good" property="basketItemId"/>">
										...
										<img src="/thumb<%=good.getDoc().getPerexImage() %>?w=100&h=100&ip=5" class="media-photo">
												...
												<div class="media-body">
													...
													<p class="summary">Počet kusov: <input type="text" class="basketQty" name="basketQty" maxlength="4" value="<iwcm:strutsWrite name="good" property="itemQty"/>"> <%= good.getItemNote() %></p>
												</div>
											</div>
										</td>
									</tr>
