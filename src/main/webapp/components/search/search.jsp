...
%>
 ...
 <div class="search">
	...
	<iwcm:present name="ragAnswer">
		<div class="card mb-3 rag-answer">
			<div class="card-body">
				<h5 class="card-title">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-sparkles-2">
				...
				<div class="card-text"><iway:request name="ragAnswer"/></div>
			</div>
		</div>
	</iwcm:present>
