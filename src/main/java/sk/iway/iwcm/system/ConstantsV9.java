...
public class ConstantsV9 {
	...
	public static void clearValuesWebJet9() {
		...
		Constants.setString("deepl_api_url", "https://api-free.deepl.com/v2", "translations", "Domena pre API volanie DeepL, ak mate PRO ucet pouzite https://api.deepl.com/v2");
