...
public class ConstantsV9 {
	...
	public static void clearValuesWebJet9() {
		...
		Constants.setString("ckeditor_pasteFromWord_disallowedContent", "table[width,height,border];td(*);td[align,valign,nowrap];th(*);th[align,valign];p[align];span;col[width]", Constants.MOD_EDITOR, "Zoznam pravidiel CKEditor Advanced Content Filter, ktoré sa odstránia pri vložení obsahu z Wordu. Pravidlá sú oddelené bodkočiarkou, položky v rámci pravidla čiarkou.");
