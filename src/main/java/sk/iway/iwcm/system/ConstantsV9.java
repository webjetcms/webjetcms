...
public class ConstantsV9 {
	...
	public static void clearValuesWebJet9() {
		...
		Constants.setString("videoClasses", "components.video_player.ratio-16x9:embed-responsive embed-responsive-16by9 ratio ratio-16x9,components.video_player.ratio-4x3:embed-responsive embed-responsive-4by3 ratio ratio-4x3,components.video_player.ratio-1x1:embed-responsive embed-responsive-1by1 ratio ratio-1x1,components.video_player.ratio-21x9:embed-responsive embed-responsive-21by9 ratio ratio-21x9,components.video_player.ratio-9x16:ratio ratio-9x16", Constants.MOD_EDITOR, "Čiarkou oddelený zoznam CSS tried pre obalenie videa (pomer strán). Formát: prekladový_kľúč:css_trieda alebo len css_trieda. Prvá položka je predvolená hodnota.");
		Constants.setString("videoItemClass", "embed-responsive-item", Constants.MOD_EDITOR, "CSS trieda pre vnútorný iframe element videa (embed-responsive-item pre Bootstrap 4, pre Bootstrap 5 môže byť prázdna).");
	}
