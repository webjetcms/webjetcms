...
public interface GalleryDimensionRepository extends DomainIdRepository<GalleryDimension, Long> {
    ...
    List<GalleryDimension> findByPathLikeAndPathLikeAndDomainId(@Param("baseFolder") String baseFolder, @Param("searchContains") String searchContains, @Param("domainId") int domainId);
