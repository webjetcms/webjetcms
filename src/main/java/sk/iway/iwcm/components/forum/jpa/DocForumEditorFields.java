...
public class DocForumEditorFields extends BaseEditorFields {
    ...
    public void fromDocForum(DocForumEntity entity, HttpServletRequest request, Prop prop) {
        ...
        //Icon to open page
        iconsHtml.append("<a href=\"" + link + "\" target=\"_blank\" class=\"preview-page-link\" title=\"" + prop.getText("history.showPage") + "\"><i class=\"far fa-eye\"></i></a> ");

        //Add icon about confirm status
        if(entity.getConfirmed()) {
            iconsHtml.append("<i class=\"fa-regular fa-circle-check\" style=\"color: #00be9f;width: 1.25em;\"></i>");
        } else {
            iconsHtml.append("<i class=\"fa-regular fa-circle-xmark\" style=\"color: #ff4b58;width: 1.25em;\"></i>");
        }
