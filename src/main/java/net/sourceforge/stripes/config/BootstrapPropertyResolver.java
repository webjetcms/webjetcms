...
public class BootstrapPropertyResolver {
    ...
    public String getProperty(String key) 
    {
        ...
        /**
         * doplnene oproti originalnemu kodu Stripes 1.5.3
         * pozrie sa, ci polozka nie je zadana cez konstantu Constants
         */
        
        if(Tools.isNotEmpty(Constants.getString("stripes." + key)))
      	  return Constants.getString("stripes." + key);
