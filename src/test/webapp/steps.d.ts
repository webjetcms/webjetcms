...
type AudioHelper = import('./helpers/audio_helper.js');
type VideoHelper = import('./helpers/video_helper.js');
...
declare namespace CodeceptJS {
  ...
  interface Methods extends Playwright, CustomWebjetHelper, AudioHelper, VideoHelper, ChaiWrapper, PixelmatchHelper, REST, JSONResponse, FileSystem, A11yHelper {}
