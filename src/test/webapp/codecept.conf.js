      ...
      users: {
        ...
        tester2: {
          login: (I) => {
            ...
            I.fillField("password", secret("*********"));
            I.forceClick("Prihlásiť sa");
            I.waitForText("Tester2 Playwright2", 30);
          },
          check: (I) => {
            I.say("checking logged user");
        ...
        testerga: {
          ...
          check: (I) => {
            I.say("checking logged user");
            I.see("Tester Google Authenticate");
            //aby sme vzdy v kazdom scenari mali prednastavenu velkost okna
            I.wjSetDefaultWindowSize();
          },
          restore: (I) => {
        ...
        jtester: {
          login: (I) => {
            ...
            I.wjSetDefaultWindowSize();
            //odosli prihlasenie
            I.fillField("username", "jtester");
            I.fillField("password", secret("*********"));
            I.forceClick("Prihlásiť sa");
            I.waitForText("Janko Tester", 30);
          },
          check: (I) => {
            I.say("checking logged user");
            I.see("Janko Tester");
        ...
        tester_forum: {
          login: (I) => {
            ...
            I.wjSetDefaultWindowSize();
            //odosli prihlasenie
            I.fillField("username", "tester_forum");
            I.fillField("password", secret("*********"));
            I.forceClick("Prihlásiť sa");
            I.waitForText("Tester_Forum Playwright", 30);
          },
          check: (I) => {
            I.say("checking logged user");
            I.see("Tester_Forum Playwright");
            //aby sme vzdy v kazdom scenari mali prednastavenu velkost okna
            I.wjSetDefaultWindowSize();
          },
          restore: (I) => {
