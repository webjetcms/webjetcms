...
function deleteFolder(I, folderName) {
     if (folderName === mainFolder) {
          I.click(mainFolder);
          I.waitForVisible(locate('.jstree-anchor.jstree-clicked').withText(mainFolder), 10);
          I.click(deleteBtn);
          DT.waitForLoader();
          DTE.save();
          I.dontSeeElement(locate('a').withText(folderName));
     } else if (folderName === subfolder1 || folderName === subfolder2) {
          I.click(mainFolder);
          I.click(folderName);
          I.click(deleteBtn);
          DT.waitForLoader();
...
function uploadImage(I, folder, image) {
     ...
     if (folder === subfolder2 || folder === testFolder) {
          ...
          I.waitForVisible('.far.fa-check-circle.fa-pull-right', 25);
          ...
          I.waitForVisible('.far.fa-exclamation-circle.fa-pull-right', 25);
