...
Before(({ I, DT, login }) => {
    ...
    DT.addContext("tree", "div.tree-col");
});
...
Scenario('Gallery - Feature - select dir location during create', ({ I, DT, DTE }) => {
    ...
    I.click(locate('#jsTree a.jstree-anchor').withText('move-from'));
...
Scenario('Gallery - Feature - allow relocated folder in editor AND handle doc update / url redirect - BEFORE', async ({ I, DT, DTE, Apps }) => {
    ...
    I.waitForVisible("#jsTree");
    I.click(locate('#jsTree .jstree-node.jstree-closed').withText('test').find('.jstree-icon.jstree-ocl'));
    I.click(locate('#jsTree .jstree-node.jstree-closed').withText('move-from').find('.jstree-icon.jstree-ocl'));
    I.click(locate('#jsTree a.jstree-anchor').withText('moving-dir'));
    I.waitForInvisible("#jsTree");
    DTE.save();
...
Scenario('Gallery - Feature - allow relocated folder in editor AND handle doc update / url redirect', ({ I, DT, DTE }) => {
    ...
    I.waitForVisible("#jsTree");
    I.click(locate('#jsTree .jstree-node.jstree-closed').withText('test').find('.jstree-icon.jstree-ocl'));
    I.click(locate('#jsTree a.jstree-anchor').withText('move-to'));
    I.waitForInvisible("#jsTree");
