...
Before(({ I, login }) => {
    ...
    if (typeof title === 'undefined') {
        title = "autotest-" + I.getRandomText();
    }
});
...
Scenario('Delivery methods datatable tests', ({I, DT, DTE}) => {
    ...
    I.say("Do valid save");
        DTE.selectOption("supportedCountries", "Slovensko");
        I.pressKey('Escape');
    ...
    I.say('Check values');
        DT.checkTableRow("deliveryMethodsDataTable", 1, ["", SL.DeliveryMethods.inStoreDelivery, title, SL.Countries.sk, "15,00", "23,00", "18,45"]);
