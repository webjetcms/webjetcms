...
Scenario("Test quiz stat sekcie", async ({ I, DT, DTE, Document }) => {
    ...
    I.click("#quizDataTable_modal > div > div > div.DTE_Header.modal-header > div > div.maximize > i.fas.ti-arrows-maximize");
    ...
    I.clickCss("#quizDataTable_modal > div > div > div.DTE_Header.modal-header > div > div.maximize > i.fas.ti-arrows-minimize");
    ...
    I.clickCss("#quizDataTable_modal > div > div > div.DTE_Header.modal-header > div > div.maximize > i.fas.ti-arrows-maximize");
