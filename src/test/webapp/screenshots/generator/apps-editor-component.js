...
function tabLink2WaitSpring(Document, I, DT, DTE) {
    I.clickCss("#pills-dt-editor-component-datatable li:nth-child(2) a");
    I.wait(5);
}
...
function screenshotWebAndApp(I, Document, docId, path, webSelector, callback1=null, callback2=null, width, height, callbackWeb=null) {
    I.switchTo();
    I.closeOtherTabs();
    I.amOnPageLng("/showdoc.do?docid="+docId);
    var counter = 1;
    ...
    if ("/components/calendar"==path) {
        I.executeScript(function() {
         window.location.href="/apps/kalendar-udalosti/?month=8&year=2023";
        });
    }
...
Scenario('apps screenshot for editor-components.jsp 1', ({ I, DT, DTE, Document }) => {
    ...
    I.amOnPageLng("/apps/gdpr-cookies/");
    Document.screenshotElement(".cookies-bar-wrapper.cookies-top", basePath+"/components/gdpr/screenshot-1"+lngSuffix+".jpg");
    I.click(".btn.more");
    Document.screenshotElement(".cookies-list", basePath+"/components/gdpr/screenshot-2"+lngSuffix+".jpg");
    I.amOnPageLng("/apps/gdpr/admin/");
    DT.filterContains("cookieName", "__");
    Document.screenshot(basePath+"/components/gdpr/screenshot-3"+lngSuffix+".jpg");

    screenshotWebAndApp(I, Document, 25209, "/components/menu", "header", tabLinkNone, null);
    I.amOnPageLng("/apps/menu/?NO_WJTOOLBAR=true");
    Document.screenshotElement(".ly-content .container", basePath+"/components/menu/screenshot-3"+lngSuffix+".jpg");
...
Scenario('apps screenshot for editor-components.jsp send link', ({ I, DT, DTE, Document }) => {
    ...
    I.wait(3);
    Document.screenshot(basePath+"/components/send_link/screenshot-1"+lngSuffix+".jpg");
    //if (1==1) return;
});

Scenario('apps screenshot for editor-components.jsp 2', ({ I, DT, DTE, Document }) => {
    ...
    screenshotWebAndApp(I, Document, 21343, "/components/banner", ".container", tabLinkNone, tabLink3Spring, 640, 480);
    ...
    I.amOnPageLng("/admin/v9/webpages/web-pages-list/?docid=22");
    DTE.waitForEditor();
    Document.screenshot(basePath+"/components/dmail/screenshot-1"+lngSuffix+".jpg");
    I.amOnPageLng("/apps/dmail/admin/?id=1");
    DTE.waitForEditor("campaingsDataTable");
    Document.screenshot(basePath+"/components/dmail/screenshot-2"+lngSuffix+".jpg");
    ...
    Document.screenshot(basePath+"/components/dmail/screenshot-3"+lngSuffix+".jpg");
    I.click(locate("#modalIframe button").withText("OK"));

    I.amOnPageLng("/admin/v9/webpages/web-pages-list/?docid=77768");
    DTE.waitForEditor();
    I.wait(4);
...
Scenario('apps screenshot for editor-components.jsp 4', ({ I, DT, DTE, Document }) => {
    ...
    I.amOnPageLng("/apps/restaurant-menu/?NO_WJTOOLBAR=true&week=2023-W48");
    Document.screenshotElement(".restaurant-menu", basePath+"/components/restaurant_menu/screenshot-1"+lngSuffix+".jpg");
    Document.screenshotAppEditor(74621, basePath+"/components/restaurant_menu/screenshot-2"+lngSuffix+".jpg", function(Document, I, DT, DTE) {
        tabLink2Spring(Document, I, DT, DTE);
        Document.screenshot(basePath+"/components/restaurant_menu/screenshot-3"+lngSuffix+".jpg");
        ...
        Document.screenshot(basePath+"/components/restaurant_menu/screenshot-4"+lngSuffix+".jpg");
...
Scenario('apps screenshot for editor-components.jsp 5', ({ I, DT, DTE, Document, i18n }) => {

    I.amOnPageLng("/admin/v9/webpages/web-pages-list/?docid=57");
    DTE.waitForEditor();
    I.wait(8);
    ...
    I.wait(3);
    I.click(i18n.get("Add to page"));
    I.wait(3);
    Document.screenshot(basePath+"/components/seo/screenshot-1"+lngSuffix+".png");

    screenshotWebAndApp(I, Document, 72299, "/components/site_browser", ".ly-content .container", tabLink1Spring, tabLink2WaitSpring, 800, 600);
});
...
Scenario('apps screenshot for editor-components.jsp apps to spring v4', ({ I, DT, DTE, Document }) => {
    ...
    Document.screenshot(basePath+"/components/video/screenshot-3"+lngSuffix+".png");
    I.switchTo();
