...
`getDashboardDefaults(context)` supplies presets only for an unconfigured profile. New optional widget types must not rewrite existing personal layouts. Mandatory types are ensured separately.
