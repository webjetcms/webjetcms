...
The text of a page created directly in the WebJET editor may contain special tags that are updated when the web page is displayed:
...
<table width="100%" class="ramikTable">
	...
	<tbody>
		...
		<tr>
			...
			<td class="t_body">
				Vypíše hodnotu atribútu požiadavky s menom nazov_atributu. Ako nazov_atributu je možné použiť rovnaké názvy ako pri <a href="dynamic_tags.jsp">HTML šablónach</a>.
				<br />
