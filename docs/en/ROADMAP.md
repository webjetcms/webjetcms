...
- [x] +Configuration - add a hierarchical module tree and the option to display unset variables (the complete list).
- [ ] +Configuration - create a tool to generate all variables by group/module into an `md` documentation file.
