# New Features Overview - 2024

This section contains descriptions of the features and **functionalities of WebJET CMS in plain language**, without unnecessary technical formulations in 2024. New entries are added to the top (below this introduction), so the newest features are always at the top.
