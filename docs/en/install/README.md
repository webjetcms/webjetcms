...
WebJET 2023 requires `Java 17` a `Tomcat 9`.
...
Currently there are the following versions of WebJET 2021:
...
More information is in [the list of changes](../CHANGELOG-2023.md#odstránenie-závislosti-na-verzii-8).
