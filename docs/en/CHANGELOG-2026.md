...
- Ninja - added field `canonical` as [optional Q field](frontend/ninja-starter-kit/ninja-jv/page/README.md#page-information) to set the canonical URL of the page. If the field is empty, the page URL will be used. You will get the value in the template as `${ninja.page.canonical}` (#OSK149).
...
- Security - updated libraries `log4j,pdfbox` (#58317-6).
