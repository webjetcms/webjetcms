...
Vypíše **console.warn** se zadaným parametrem pokud je při inicializaci pluginu nastaven `debug` na `true`, nebo je-li v URL adrese nastaven parametr `ninjaDebug` na `true`.
