...
Hodnota nastavená skupině šablon v poli :european_castle: `Názov projektu`.
...
Hodnota nastavená skupině šablon v poli :european_castle: `Autor`.
...
Hodnota nastavená skupině šablon v poli :european_castle: `Copyright`.
...
Hodnota nastavená skupině šablon v poli :european_castle: `Developer`.
...
Hodnota nastavená skupině šablon v poli :european_castle: `Generátor`.
...
Hodnota nastavená skupině šablon v poli :european_castle: `Prefix textových kľúčov`.
...
Hodnota nastavená skupině šablon v poli :european_castle: `Pole A`.
...
Hodnota nastavená skupině šablon v poli :european_castle: `Pole B`.
...
Hodnota nastavená skupině šablon v poli :european_castle: `Pole C`.
...
Hodnota nastavená skupině šablon v poli :european_castle: `Pole D`.
