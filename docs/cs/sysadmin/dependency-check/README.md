...
Pomocí nástroje [OWASP Dependency-Check](https://jeremylong.github.io/DependencyCheck/index.html) můžete snadno kontrolovat zranitelnosti v Java a JavaScript knihovnách web aplikace. Ty doporučujeme kontrolovat na pravidelné bázi.
...
- ```--suppression``` - ​​cesta k [souborům s výjimkami](../../developer/backend/security.md#kontrola-zranitelností-v-knihovnách), typicky je tento soubor součástí git repozitáře.
- ```--scan``` - ​​cesta k souboru/adresáři, který se má analyzovat.
