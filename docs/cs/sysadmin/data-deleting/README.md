...
Aplikace **Mazání dat** vám umožňuje odstranit nepotřebná data z databáze, čímž můžete zvýšit výkon serveru a uvolnit místo na disku.
Tento nástroj naleznete v sekci **Nastavení** pod položkou **Mazání dat**.
