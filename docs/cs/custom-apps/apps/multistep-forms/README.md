...
Každý takto vytvořený zpracovatel formuláře je získán v [FormSettingsService](../../../../../src/main/java/sk/iway/iwcm/components/form_settings/rest/FormSettingsService.java) a následně nabídnut v editoru pro výběr zpracovatele formuláře.
...
!>**Upozornění:** O načtení a vyvolání jednotlivých metod zpracovatele formulářů (je-li definován) se stará třída [MultistepFormsService](../../../../../src/main/java/sk/iway/iwcm/components/multistep_form/rest/Mult