...
Základním prvkem je třída [BaseDeliveryMethod](../../../../../../src/main/java/sk/iway/iwcm/components/basket/delivery_methods/rest/BaseDeliveryMethod.java), která má volitelná pole AL.

## Přidání nového způsobu doručení

Pro přidání nového způsobu doručení musíme vytvořit Servis např. jako [InStoreService](../../../../../../src/main/java/sk/iway/iwcm/components/basket/delivery_methods/rest/InStoreService.java). Každý způsob doručení vyžaduje vlastní soubor.
...
- Povinné dědění třídy ```BaseDeliveryMethod```, která definuje povinné metody k implementaci a poskytuje podpůrnou logiku.
