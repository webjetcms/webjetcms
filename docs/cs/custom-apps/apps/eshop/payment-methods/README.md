...
Základním prvkem je třída [BasePaymentMethod](../../../../../../src/main/java/sk/iway/iwcm/components/basket/payment_methods/jpa/PaymentMethodEntity.java), která má volitelná pole AL.

## Přidání nového způsobu platby

Pro přidání nového způsobu platby musíme vytvořit Servis např. jako [GoPayService](../../../../../../src/main/java/sk/iway/iwcm/components/basket/payment_methods/rest/GoPayService.java). Každý způsob platby vyžaduje vlastní soubor.
...
- Povinné dědění třídy ```BasePaymentMethod```, která definuje povinné metody k implementaci a poskytuje podpůrnou logiku.
...
- ```isRequired```, pokud je nastavena na hodnotu ```true```, bude se pole brát za povinné
- ```defaultValue```, slouží k přednastavení hodnoty do pole

## Třída ```BasePaymentMethod```

Třída [BasePaymentMethod](../../../../../../src/main/java/sk/iway/iwcm/components/basket/payment_methods/rest/BasePaymentMethod.java) obsahuje veškerou potřebnou logiku pro přidávaný nový způsob platby. Třída je primárně určena dědicí platby, takže veřejně dostupné jsou pouze metody pro logování chyb.
...
Třída [PaymentMethodsService](../../../../../../src/main/java/sk/iway/iwcm/components/basket/payment_methods/rest/PaymentMethodsService.java) poskytuje všechny veřejné metody pro práci s platebními způsoby, které budete platit.
