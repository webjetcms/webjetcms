...
- Použité frameworky
    ...
    - Grafy přes amcharts
      ...
      - [Statistiky pomocí grafů](/developer/frameworks/charts/stats-by-charts/README.md)
...
- Datatables
    ...
    - [Možnosti konfigurace columns objektu pomocí JAVA anotací](/developer/datatables-editor/datatable-columns.md)
    - [REST Controller](/developer/datatables/restcontroller.md)
    - [Export a import](/developer/datatables/export-import.md)
    - [Oddělení dat domén](/developer/datatables/domainid.md)
- Datatables Editor
...
- Testování
    ...
    - [Testování přístupnosti](/developer/testing/a11y.md)
    ...
    - [Nahrávání prezentačních videí](/developer/testing/video.md)
