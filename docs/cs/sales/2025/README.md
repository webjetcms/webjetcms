...
![AI asistenti v editoru](../../redactor/ai/datatables/ckeditor.png)
...
![Manažer dokumentů](../../redactor/files/file-archive/datatable.png)
...
![Automatický překlad stránky do angličtiny](../../redactor/apps/docmirroring/doc-en.png)
...
![Přehled kampaní](../../redactor/apps/dmail/campaings/dataTable.png)

![Nastavení doménových limitů](../../redactor/apps/dmail/domain-limits/datatable.png)
...
![Rezervace času – tabulka dostupnosti](../../redactor/apps/reservation/time-book-app/app-page.png)

![Rezervace dní – kalendář s cenami](../../redactor/apps/reservation/day-book-app/app-table_B.png)
...
![Správa produktů](../../redactor/apps/eshop/product-list/datatable.png)
