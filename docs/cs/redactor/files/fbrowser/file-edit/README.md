...
Jelikož úprava souborů v aplikaci [Průzkumník](../../fbrowser/README.md) má několik stavů, věnujeme se jí v této samostatné sekcí.
...
Pokud cesta obrázku **obsahuje** část `/gallery`, znamená to, že je to obrázek z galerie. V takovém případě se otevře v novém okně prohlížeče aplikace [galerie](../../../../redactor/apps/gallery/README.md), kde se pro daný obrázek automaticky otevře editor.
