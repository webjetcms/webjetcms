...
- **Způsob platby**, poskytuje na výběr dostupné způsoby platby, které jsou **nakonfigurovány**.
...
!>**Upozornění:** daný způsob platby musí podporovat [akce nad platbami](./payments.md#akcie-nad-platbami).
...
- **Úspěšná platba**, pokud vytvořená platba má platnou částku a je označena jako **potvrzená platba**
...
- refundace tohoto typu platby je povolena v anotaci `@PaymentMethod` a je řádně implementována (např přes platební bránu). Více se dočtete v části [způsoby platby](../../../../custom-apps/apps/eshop/payment-methods/README.md).
- platba je **potvrzena**
...
Refundovali jste povolenou platbu i správnou částku, ale refundace se nezdařila. Chyba se například mohla stát na straně platební brány, která se starala o žádost k refundaci platby. V takovém případě se do tabulky vloží záznam o neúspěšné refundaci, tedy platba ve stavu **Neúspěšná refundace**. Automatický je tato platba označena jako **nepotvrzená** av poli **popis platby** bude i chybová hláška. Formát hlášky se může měnit v závislosti na způsobu platby a tom, jak tuto platbu implementoval programátor.

![](editor_payments_refund_err.png)

**Refundace se povedla**

V případě, že všechny podmínky byly splněny a při procesu refundace nenastála žádná chyba. Do tabulky plateb bude automaticky přidána platba ve stavu **Úspěšná refundace**. Všimněte si, že **suma refundace má zápornou hodnotu**, protože jsme odebírali ze zaplacené částky. V závislosti na implementaci refundovaného způsobu platby může pole **popis platby** obsahovat i bonusové informace, jako `id` refundované platby.

Platba kterou jste refundovali, nabude stav **Refundovaná platba** nebo **Částečně refundovaná platba**, podle toho zda jste je refundovali celou nebo jen částečně. Pokud platbu refundujete na vícekrát, každá refundace bude mít svou reprezentaci ve formě platby se stavem **Úspěšná refundace** (pokud se podařila).
...
Patička tabulky obsahuje užitečnou informaci o tom, kolik z celkové částky objednávky je již reálně uhrazeno a také to, jaká je ta celková cena objednávky. Uživatel má tak přehled, kolik ještě musí zaplatit nebo ať už je vše zaplaceno. Počítají se pouze platby a refundace, které jsou **potvrzeny**.
...
!>**Upozornění:** pokud provádíte úpravy v **Přehledu plateb**, měli byste pro tuto objednávku **Odeslat notifikaci klientovi**, jelikož změna ceny k zaplacení může změnit i stav celé objednávky.