...
Pokud přihlášený uživatel má omezená práva na složky se nezobrazí **kompletní návštěvnost**, ale bude nastavena první složka, na kterou má uživatel uděleno právo.
...
Přednastavená možnost je **Všechny web stránky** a zobrazí data všech web stránek, které vyhovují ostatním parametrům.
