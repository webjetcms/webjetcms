...
Obě aplikace musí být nastaveny na stejnou složku novinek. Pokud se tato nastavení neshodují, **Kalendář novinek** nebude schopen správně filtrovat novinky pro vybrané datum. Propojení mezi aplikacemi funguje tak, že první aplikace **Novinky** vložená za **Kalendář novinek** v editoru s ním bude automaticky propojena.
