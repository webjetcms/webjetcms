...
- ID dokumentu oznámení pro uživatele - pokud je nastaveno na hodnotu docId nějaké webové stránky, pak se po úspěšném uložení formuláře odešle na e-mail návštěvníka (z pole e-mail / email) e-mail s textem webové stránky. Může to být například poděkování za vyplnění formuláře nebo další pokyny, jak postupovat.
