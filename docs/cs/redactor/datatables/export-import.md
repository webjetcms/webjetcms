...
- Exportem lze najednou získat **maximálně 50 000 záznamů**. Při potřebě exportovat více záznamů použijte vícenásobné exportování s využitím filtrování. Maximální počet záznamů lze zvýšit nastavením konf. proměnné `datatablesExportMaxRows`.
