...
Při editaci existující položky (pokud se edituje jeden záznam) se v hlavičce dialogového okna editoru zobrazuje název editované položky (na ukázce text **Produktová stránka**) namísto obecného textu **Upravit**.
...
V nastavení zobrazení sloupců je také tlačítko **Obnovit**, které obnoví **výchozí nastavení seznamu sloupců**. Kromě toho tam máme i tlačítka **Zobrazit všechna** a **Skrýt všechna**, která jedním kliknutím zapnou nebo vypnou zobrazení všech sloupců.
