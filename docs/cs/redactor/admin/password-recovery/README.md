...
Klepnutím na možnost ![](admin-recover-password-btn.png ":no-zoom") se zobrazí formulář pro obnovení hesla.
...
Klepnutím na možnost **Zapomněli jste vaše heslo?** se zobrazí skryté pole pro obnovení.
...
- odkaz pro změnu hesla, **Chcete-li si změnit heslo, klikněte sem do 30 minut.**
...
Klepnutím na první odkaz, **Chcete-li si změnit heslo, klikněte sem do 30 minut.**, se dostanete na stránku ke změně hesla.
...
!> **Upozornění:** po úspěšné změně hesla se odkaz, kterým jste se dostali k formuláři na změnu **stává nefunkčním**, čili nebude možné použít k opětovné změně hesla pro stejného nebo jiného uživatele. Odkaz se stává také nefunkční, pokud jste akci neprovedli do 30 minut od přijetí emailu.
...
Kliknutím na druhý odkaz **Pokud jste nepožádali o změnu hesla můžete tuto akci zrušit kliknutím sem.** se opět dostanete na stránku, která Vám sdělí že akce změny hesla byla zrušena, čímž se první odkaz na změnu hesla **stala nefunkční**.
