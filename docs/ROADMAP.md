...
> Verzia 2023.52 je zameraná na zlepšenie bezpečnosti.
...
- Web stránky - pridať možnosť obnovenia zmazaného priečinka tak, aby sa korektne nastavil web stránkam atribút `available`.
...
- [ ] Aplikácie - zlepšiť opis každej aplikácie, aktualizovať obrázky aplikácie (#55293).
- [ ] Foto galéria - optimalizovať množstvo načítaných dát
- [ ] Foto galéria - image editor sa inicializuje pri každom otvorení okna, upraviť, aby sa použil už existujúci editor
...
- [ ] Editor - pridať možnosť zobraziť pre vybrané web stránky editor typu HTML, ktorý sa nebude dať prepnúť do WYSIWYG režimu. Použité na špeciálne stránky integrujúce rôzne JavaScript aplikácie alebo špeciálne komponenty. Vhodný editor je [Ace-code](https://www.npmjs.com/package/ace-code).
- [ ] Publikovanie OpenSource/Community verzie WebJET CMS na ```github.com``` (#55789,#55773).
- [ ] +Datatabuľky - vo web stránkach/galérii pri nastavení iného pomeru stĺpcov sa zle zobrazujú tlačidlá.
...
- [ ] +Prechod zo Struts framework na Spring - postupne prepísať kód všetkých tried do Spring kontrolórov (#55389,#55469,#55489,#55493,#55469,#55501,#55609,#55613,#55617,#55649,#55701).
