...
- [x] #53825 - Datatabuľky - pridaná všeobecná funkčnosť duplikovania záznamov. Bolo by super doplniť testovanie tejto funkčnosti priamo do všeobecného testu datatabuliek (napr. pred zmazaním záznamu vyskúšať ešte jeho duplikovanie a overiť, že sa tam záznam nachádza 2x) - ```src/test/webapp/pages/DataTables.js```.
...
- [ ] Zabudnuté heslo/vynútená zmena hesla pri slabom hesle - overiť, že nie je možné použiť aktuálne heslo.
