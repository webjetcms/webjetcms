...
## Zarovnanie prehľadov, zdroje návštevnosti a plánované publikovanie

- Nové a resetované rozloženia používajú Návštevnosť `3×3`, tri metriky `1×1` a Pokračujte v práci `3×2`. Pod nimi nasledujú Odkiaľ prichádzajú, Najbližšie publikovanie a Newsletter, každý `2×2`. Staršie uložené rozmery zostávajú podporované; zmena predvoleného rozloženia osobné nastavenia automaticky neprepisuje.
- Základný riadok mriežky má 128 px; obsah môže výšku zväčšiť. Pri overenom desktopovom rozložení majú metriky približne 138 px, Návštevnosť 424 px a spodné tri karty rovnakých 271 px. Pokračujte v práci končí na rovnakej hrane ako Návštevnosť. Rozmery boli nastavené aj v aktuálnom otvorenom profile cez nastavenia widgetov.
- Pokračujte v práci zachováva šesť stránok vo všetkých veľkostiach. Zoznam má vlastné natívne rolovanie, fokus pre klávesnicu a rovnaké oddelenie udalostí od hlavného scrollbara ako aktívne prihlásenia. Spoločný helper uvoľní listenery pri zániku widgetu.
- Zdroje návštevnosti zostávajú grafom AmCharts cez ChartTools. Jemné vodorovné pruhy majú nad sebou skutočný názov zdroja a jeho percentuálny podiel; os a mriežka ustúpili kompaktnému zobrazeniu. Menovateľom je celý evidovaný počet, nie iba zobrazené položky. Malá karta zobrazuje tri zdroje. Viditeľné „Údaje grafu“ sú odstránené, presné počty a podiely zostávajú v tooltipoch a tabuľke pre čítačky obrazovky.
- Všetky tri spodné karty otvárajú príslušný modul cez nadpis so šípkou. Spodný odkaz „Zobraziť všetko“ je odstránený. Newsletter používa stručný stav, názov kampane, počet odoslaní, priebeh a počet chýb; zaznamenané otvorenia a kliknutia zostávajú dostupné čítačkám obrazovky.
- Prázdne publikovanie spôsobovalo obmedzenie na nasledujúcich 30 dní; položky z auditu majú dátum v roku 2030. Projekcia teraz číta rovnakú cache plánovaných stránok ako audit, zachováva kontroly domény a oprávnení a vracia šesť najbližších budúcich udalostí bez horného dátumového limitu. Rozlišuje publikovanie a ukončenie publikovania, odstraňuje duplicity a zoraďuje udalosti podľa dátumu. Kompaktná karta zobrazuje dve udalosti, väčší existujúci variant päť. Dátumy mimo aktuálneho roka výslovne uvádzajú rok. Nadpis vedie na zoznam „Čaká na publikovanie“ pre používateľa s právom `cmp_adminlog`, inak na zoznam webových stránok.
