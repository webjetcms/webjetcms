...
-   `DOUBLE_PIE`, vrátený typ dát je jednoduchý list objektov, ```java List<T>```, kde objekt musí obsahovať textovú premennú(kategória) a dve číselné premenné (každá hodnota pre jednu kategóriu)
