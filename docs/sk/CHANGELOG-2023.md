...
- Web stránky - doplnená logika mazania stránok vo [viacerých priečinkoch](redactor/webpages/editor/README.md#zaradenie-v-stromovej-štruktúre). Pri zmazaní hlavnej web stránky z koša sa vymažú aj všetky stránky v ostatných priečinkoch (#55813).
