...
- GitHub pipeline - po mergnutí pull requestu sa automaticky vygeneruje príspevok na sociálne siete pomocou LLM (GitHub Copilot / Google Gemini) a odošle sa emailom spolu s prípadnými screenshotmi z dokumentácie (#177).
