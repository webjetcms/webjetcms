...
- Presmerovania - manuálne vytvorené presmerovania sú odlíšené od automatických, označené sivým pozadím a je možné ich samostatne [filtrovať v zozname presmerovaní](redactor/webpages/redirects/README.md#automatické-a-manuálne-presmerovania) (#58625).
