...
- Štatistika - obnovená [Mapa kliknutí](redactor/apps/stat/heat-map.md) so samostatnými údajmi pre presné šírky okna a náhľadom historického obsahu podľa konca obdobia. Meranie sa zapína v šablóne alebo skupine šablón a rešpektuje súhlas so štatistickými cookies.
