...
- Webové stránky - Opravené obnovenie stránky, ktorá bola vytvorená skrz zrkadlenie a nemala historický záznam, ktorý sa dal použiť na obnovenie (#osk423).
- Webové stránky - Pri obnovení stránky z koša sa použije historická verzia aby sa zachoval jej pôvodný stav pred vymazaním (#osk423).
