...
- Editor stránok - opravené určenie priečinka pre nahrávanie obrázkov/súborov pri novej stránke s duplicitným názvom: priečinok teraz zodpovedá skutočnej URL adrese stránky vrátane suffixu `-2`, `-3` atď (#53861).
