...
Karta sa zobrazí iba v prípade, ak je zvolená možnosť **Zobraziť len vybrané dokumenty**. V karte je vnorená tabuľka zobrazujúcu **IBA** dokumenty, ktoré je možné použiť ako vybrané dokumenty. Tieto dokumenty musia spĺňať:
