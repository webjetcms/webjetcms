...
V stĺpci priečinky je možné prechádzať a pridať/editovať/zmazať priečinok stromovej štruktúry galérie. Viac sa dočítate v časti [Správa štruktúry](structure.md).
...
Ak potrebujete mať hodnotu na prvom riadku prázdnu zadajte výraz `---`, ten je spracovaný ako prázdna hodnota (nie je možné zadať prázdnu hodnotu na prvom riadku, pretože pri uložení a čítaní hodnôt z databázy sa na začiatku a konci odrežú biele znaky).
