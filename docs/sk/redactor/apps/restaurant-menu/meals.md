...
Alergény vyberáte z výberového menu, v ktorom je možné označiť viaceré možnosti. Alergénov je 14 (počet sa dá nastaviť v konfiguračnej premennej `restaurantMenu.alergensCount`) a definujú sa v prekladových kľúčoch s prefixom `components.restaurant_menu.alergen`:
