...
- <i class="ti ti-exclamation-circle" style="color: #E00028;"></i>, ikona zodpovedná stavu **Zlé mapovanie**. Previazanie stránok nadobudne tento stav v prípade objavenia viacerých previazaných stránok v rovnakej jazykovej mutácií.
