...
- `2026.0.25-jakarta` - stabilizovaná verzia 2026.0.25 s opravami chýb voči verzii 2026.0 (bez pridania vylepšení zo SNAPSHOT verzie).
- `2026.0.25` - stabilizovaná verzia 2026.0.25 s opravami chýb voči verzii 2026.0 (bez pridania vylepšení zo SNAPSHOT verzie).
- `2026.18-jakarta` - stabilizovaná verzia 2026.18, nepribúdajú do nej denné zmeny.
- `2026.0.18-jakarta` - stabilizovaná verzia 2026.0.18 s opravami chýb voči verzii 2026.0 (bez pridania vylepšení zo SNAPSHOT verzie).
- `2026.0.18` - stabilizovaná verzia 2026.0.18 s opravami chýb voči verzii 2026.0 (bez pridania vylepšení zo SNAPSHOT verzie).
