...
- Predvolený SEO opis - použije sa, ak stránka nemá zadaný SEO opis ani perex.
...
SEO opis a alternatívny text sa ukladajú samostatne pre jazyk zvolený v hlavičke zoznamu. SEO obrázok je spoločný pre všetky jazyky skupiny. Presné poradie použitia hodnôt opisuje [API objektu Page](../ninja-starter-kit/ninja-jv/page/README.md).
