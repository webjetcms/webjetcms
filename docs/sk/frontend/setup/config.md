...
- `editorTargetBlankFunction` predvolene `return openTargetBlank(this, event)` - meno JavaScript funkcie, ktorá sa použije namiesto target=\"_blank\" a target='_blank' ako onclick.
