...
ak nechcete povoliť všetky REST služby môžete nastaviť povolenie na IP adresu len pre REST služby headless režimu:
...
všetky nastavte na IP adresu, z ktorej budú volané, napríklad `127.0.0.1`.
