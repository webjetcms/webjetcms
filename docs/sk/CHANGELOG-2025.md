...
- Navbar - pridaná možnosť použiť vlastnú implementáciu generátora navigačnej lišty. Cez konfiguračnú premennú `navbarDefaultType` je možné nastaviť meno triedy implementujúcej `NavbarInterface` (#PR_NUMBER).
