...
- Novinky / Šablóny noviniek - presun poľa `contextClasses` z aplikácie Novinky do Šablóny noviniek, aby sa vlastnosť nastavovala priamo v šablóne noviniek. Pôvodná hodonnta `contextClasses` z NOviniek bude naďalej fungovať (#58245).
