...
- Značky - upravené zobrazené značiek, v prípade duplicity hodnôt [#115](https://github.com/webjetcms/webjetcms/issues/115). Porovnanie je bez vplyvu diakritiky a veľkých/malých písmen.
