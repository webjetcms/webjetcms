...
- Štýl - výber štýlu pre elementy `DIV,SECTION` umožňujú nastaviť viaceré štýly súčasne. Opakovaným zvolením už nastaveného štýlu sa tento štýl odstráni (#OSK140).
