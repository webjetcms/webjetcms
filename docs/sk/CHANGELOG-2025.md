...
- Bezpečnosť - prísnejšia kontrola URL adries administrácie - je potrebné, aby URL adresa v administrácii mala na konci znak `/`, nesprávna adresa je `/admin/v9/webpages/web-pages-list`, správna `/admin/v9/webpages/web-pages-list/`, týka sa aj aplikácií, čiže adries začínajúcich na `/apps/APP/admin/`. Je potrebné aby programátor skontroloval definície URL adries v súboroch `modinfo.properties` (#57793).
