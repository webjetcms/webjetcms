...
- [Datatables columns](#datatables-columns)
  - [Príklady](#príklady)
  - [Vlastnosti @DataTableColumn](#vlastnosti-datatablecolumn)
  - [Vlastnosti @DataTableColumnEditor](#vlastnosti-datatablecolumneditor)
  - [Vlastnosti DataTableColumnType](#vlastnosti-datatablecolumntype)
  - [Možnosti výberového poľa](#možnosti-výberového-poľa)
  - [Povinné polia](#povinné-polia)
  - [Validácie](#validácie)
  - [JS Helper pre rozšírenie vlastností](#js-helper-pre-rozšírenie-vlastností)
  - [Vnorené atribúty](#vnorené-atribúty)
  - [Sortovanie poradia polí](#sortovanie-poradia-polí)
  - [Preklady názvov stĺpcov](#preklady-názvov-stĺpcov)
...
- ```className``` - doplnkový CSS štýl nastavený na ```TD``` elemente, ak chcete nahradiť CSS štýl nastavený pomocou ```inputType``` zadajte ho so znakom ```!``` na začiatku - https://datatables.net/reference/option/columns.className
